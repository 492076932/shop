...
### V1.9.0 更新简介 2025/6/6
1. 新增 底部导航纯图标样式和纯文字样式
2. 新增 新版本微信商家转账，支持微信小程序和微信公众号网页
3. 修复 店铺装修->菜单栏组件，因为精度不准确导致缺失菜单的问题
4. 修复 小程序端完善身份信息时，抽屉不弹出的问题

### V1.8.7 更新简介 2024/11/22
1. 新增 订单详情页面自助申请发票
2. 修复 富文本显示行距问题
3. 修复 小程序登录模态框不显示
4. 修复 上传图片组件，无法删除图片
5. 优化 微信公众号网页授权登录，自动获取登录入口的准确路径
6. 优化 确认提交订单时候异常状态
7. 优化 活动倒计时展示效果
8. 优化 分销中心用户信息
9. 优化 客服聊天
